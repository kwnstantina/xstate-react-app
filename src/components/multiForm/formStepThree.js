...
const FormStepThree = ({ nextStep, page, current }) => {
  ...
  const handlePreviousPage = () => {
    nextStep("PREVIOUS", {
      nextStep: 2,
      stepTwoValues: data.context?.stepTwoValues,
      values: data.context?.stepTwoValues,
      step: page,
    });
    navigate(-1);
  };
      ...
      <form className="form__question" onSubmit={() => false}>
        <label htmlFor="thirdFriendName">
          ...
          <span
            ...
            style={{
              color: data.context.errors.thirdFriendName
                ? "#ef5350"
                : "#9500ae",
            }}
          >
          ...
          {data.context.errors.thirdFriendName && (
            <hr
              style={{
                height: "5px",
                color: "#ef5350",
        ...
        <label htmlFor="thirdFriendEmail">
          ...
          <span
            className="form__floating_label"
            style={{
              color: data.context.errors.thirdFriendEmail
                ? "#ef5350"
                : "#9500ae",
            }}
          >
          ...
          {data.context.errors.thirdFriendEmail && (
            <hr
              style={{
                height: "5px",
                color: "#ef5350",
