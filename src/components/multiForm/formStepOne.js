...
const FormStepOne = ({
    ...
    if (current.context.values && current.context.values.name) {
      send("INITIAL_VALUES", {
        initial: [
          {
            key: "name",
            value: current.context.values.name,
          },
  ...
  const handleSubmit = () => {
    ...
    nextStep("NEXT", {
      totalNumber: checkTotalNumber,
      values: data.context?.values,
      step: checkTotalNumber,
    });
      ...
      <form className="form__question">
        <label htmlFor="name">
          <input
            ...
            autoComplete="off"
            name="name"
            value={data.context.values?.name || ""}
            required
            onChange={(e) => handleChange(e)}
          />
          <span
            className="form__floating_label"
            style={{ color: data.context.errors.name ? "#ef5350" : "#9500ae" }}
          >
            Name
          </span>
          {data.context.errors.name && (
            <hr
              style={{
                height: "5px",
                color: "#ef5350",
        ...
        <label htmlFor="email">
          <input
            ...
            name="email"
            required
            value={data.context.values?.email || ""}
            onChange={(e) => handleChange(e)}
          />
          <span
            className="form__floating_label"
            style={{ color: data.context.errors.email ? "#ef5350" : "#9500ae" }}
          >
            Email
          </span>
          {data.context.errors.email && (
            <hr
              style={{
                height: "5px",
                color: "#ef5350",
        ...
        <label htmlFor="phoneNumber">
          <input
            ...
            autoComplete="off"
            name="phoneNumber"
            value={data.context.values?.phoneNumber || ""}
            maxLength="10"
            required
            onChange={(e) => handleChange(e)}
          />
          <span
            className="form__floating_label"
            style={{
              color: data.context.errors.phoneNumber ? "#ef5350" : "#9500ae",
            }}
          >
            Phone Number
          </span>
          {data.context.errors.phoneNumber && (
            <hr
              style={{
                height: "5px",
                color: "#ef5350",
        ...
        <label htmlFor="totalMembers">
          <input
            ...
            min="1"
            max="3"
            value={data.context.values?.totalMembers || ""}
            required
            onChange={(e) => handleChange(e)}
          />
          <span
            className="form__floating_label"
            style={{
              color: data.context.errors.totalMembers ? "#ef5350" : "#9500ae",
            }}
          >
            Total Members
          </span>
          {data.context.errors.totalMembers && (
            <hr
              style={{
                height: "5px",
                color: "#ef5350",
